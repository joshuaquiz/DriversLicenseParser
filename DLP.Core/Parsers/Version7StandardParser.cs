    ...
    public static class Version7StandardParser
    {
        public static DriversLicenseData ParseDriversLicenseData(string data)
        {
            ...
            return new DriversLicenseData
            {
                ...
                ExpirationDate = splitUpData.TryGetValue(Version7StandardMarkers.ExpirationDateMarker).ParseDateTimeMonthDayYear(),
                IssueDate = splitUpData.TryGetValue(Version7StandardMarkers.IssueDateMarker).ParseDateTimeMonthDayYear(),
                DateOfBirth = splitUpData.TryGetValue(Version7StandardMarkers.DateOfBirthMarker).ParseDateTimeMonthDayYear(),
