    ...
    public static class Version5StandardParser
    {
        public static DriversLicenseData ParseDriversLicenseData(string data)
        {
            ...
            return new DriversLicenseData
            {
                ...
                ExpirationDate = splitUpData.TryGetValue(Version5StandardMarkers.ExpirationDateMarker).ParseDateTimeMonthDayYear(),
                IssueDate = splitUpData.TryGetValue(Version5StandardMarkers.IssueDateMarker).ParseDateTimeMonthDayYear(),
                DateOfBirth = splitUpData.TryGetValue(Version5StandardMarkers.DateOfBirthMarker).ParseDateTimeMonthDayYear(),
                ...
                PostalCode = splitUpData.TryGetValue(Version5StandardMarkers.PostalCodeMarker),
