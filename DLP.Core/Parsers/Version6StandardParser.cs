...
public static class Version6StandardParser
{
        ...
        out IReadOnlyDictionary<string, string?> splitUpData)
    {
        ...
        return new DriversLicenseData
        {
            ...
            ExpirationDate = splitUpData.TryGetValue(Version6StandardMarkers.ExpirationDateMarker).ParseDateTimeMdyThenYmd(),
            IssueDate = splitUpData.TryGetValue(Version6StandardMarkers.IssueDateMarker).ParseDateTimeMdyThenYmd(),
            DateOfBirth = splitUpData.TryGetValue(Version6StandardMarkers.DateOfBirthMarker).ParseDateTimeMdyThenYmd(),
